...
from optimizer.lr_scheduler.fairseq_lr_scheduler import FairseqLRScheduler
...
# automatically import any Python files in the optimizer/lr_scheduler/ directory
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and not file.startswith('_'):
        module = file[:file.find('.py')]
        importlib.import_module('optimizer.lr_scheduler.' + module)
